	...
	export function playDepartureMelodySelect(melody: DepartureMelody): void {
	    switch (melody) {
	        ...
	        case DepartureMelody.TetudouSyouka:
			    // 鉄道唱歌（汽笛一声 新橋を〜）
				music.setTempo(80);
				music.playMelody("G4:3 R:1 G4:1 R:1 G4:3 R:1 A4:1 R:1 B4:3 R:1 B4:1 R:1 B4:3 R:1 A4:1 R:1 G4:3 R:1 G4:1 R:1 G4:3 R:1 E4:1 R:1 D4:6 R:2 R:1 E4:3 R:1 E4:1 R:1 D4:3 R:1 E4:1 R:1 G4:3 R:1 G4:1 R:1 B4:3 R:1 B4:1 R:1 A4:3 R:1 A4:1 R:1 G4:3 R:1 A4:1 R:1 B4:6 R:1 R:2", 80);
	            break;
	    }
   	}
